...
//	public BoardDirection whasdfichWayIsMy(RelativeDirection rel, BoardDirection facing) throws NotPossibleException {
//		switch (rel) {
//		case RIGHT:
//			switch (facing) {
//
...
//1. Figure out which way you are going
		try {
			...
			BoardDirection myTurn = you.whichWayIsMy(rel, facing);

			// 3. Is right safe?
			Coordinate thatAWay = you.getAdjacentCoordinate(myTurn);
